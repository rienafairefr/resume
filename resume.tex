...
\begin{minipage}[t]{0.275\textwidth} % 27.5% of the page width for the second row of icons
	...
	\icon{Twitter}{12}{\href{https://twitter.com/m_berthome}{@m\_berthome}}\\
...
\begin{entrylist}
    \entry
		{\sseptember{} 2019 -- \\\sfebruary{} 2020}
		{\en{Startup founder}\fr{Porteur de projet startup}}
		{INRIA, Euratechnologies \href{https://www.inria.fr/centre/lille}{\logo{INRIA.eps}}}
		{
		    \href{https://www.whisbee.eu}{\logo{whisbee.png}} Whisbee, \fr{le connecteur pour vos données bancaires}%
		    \en{connector for your banking data}\\
			Business dev, code: Budget Insight, Auth0, APIs, devOps, backend, frontend
		}
	\entry
		{\june{} 2017 -- }
		...
		{
			\en{Sysadmin, backend, frontend \& embedded}
			\fr{Développement serveur, frontend \& embarqué} \href{https://www.iot-lab.info}{\logo{fit-iotlab.png}}
		}
	\entry
		{\april{} 2017 -- }
		{\en{Freelance Electronics \& Laser cutting instructor}\fr{Formateur électronique et découpe laser en freelance}}
		{Techshop Lille \href{https://www.techshoplm.fr/le-lieu-lille}{\logo{Techshop.png}}}

	\entry
		{2014 -- 2017}
		{\en{Research engineer}\fr{Ingénieur de recherche}}
		{IEMN \en{Lille campus}\fr{Villeneuve d'Ascq} \href{https://www.iemn.fr/la-recherche/les-groupes/microelecsi}{\logo{CNRS.jpg}}}
		{\en{Maintenance, execution of cutting jobs, development of interface software}\fr{Maintenance, exécution de jobs de découpe, développement d'interface logicielle}}
	\entry
		{2010 -- 2013}
...
\cvsect{\en{Technologies}\fr{technologies}}

\begin{entrylist}
    \tableentry{Python}{Flask, SQLAlchemy}%
    \tableentry
        {Java}
        {%
            \en{Modified \& maintained API services\\Minecraft modding}%
            \fr{Modifié et maintenu des services API\\Création de mods Minecraft}%
        }%
    \tableentry
        {sysadmin}
        {%
            \en{Deployed \& installed various Linux servers, both at work \& personal}%
            \fr{Déployé et installé des serveurs Linux, serveur pro \& familial (NextCloud)}%
        }%
    \tableentry
        {devOps}
        {%
            \en{Good knowledge of Docker, IaC. Interested in k8s}%
            \fr{bonne connaissance de Docker, IaC, intéressé par k8s}
        }%
\end{entrylist}
